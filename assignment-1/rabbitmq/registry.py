...
class Registry(object):
    def __init__(self, name):
        ...
        self.rpc_queue = self.channel.queue_declare(queue=f"{name}_registry_rpc")
        self.servers = set()
    ...
    def on_request(self, ch, method, props, body):
        ...
        if payload["method"] == "Register":
            ...
            ch.basic_publish(
                ...
                routing_key=props.reply_to,
                properties=pika.BasicProperties(correlation_id=props.correlation_id),
                body=json.dumps(self.servers, default=tuple),
            )
            ch.basic_ack(delivery_tag=method.delivery_tag)
    ...
    def start(self):
        ...
        self.channel.basic_consume(
            queue=self.rpc_queue.method.queue, on_message_callback=self.on_request
        )
